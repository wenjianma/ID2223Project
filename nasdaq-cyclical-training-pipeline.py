...
stub = modal.Stub("nasdaq_cyclical")
...
def f():
    ...
    # df_nasdaq = pd.read_csv('Tools/GC=F_test.csv')
    ...
    model_nasdaq.add(LSTM(units=128, return_sequences=True,
    ...
    # model_nasdaq.fit(X_nasdaq, Y_nasdaq, epochs=5, batch_size=32, verbose=1)
